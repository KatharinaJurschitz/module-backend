...
public class SeveralValues {
    ...
    public SeveralValues(@Value("${basic.several.naturalnumbers}") List<Integer> numbers, @Value("${basic.several.decimalnumbers}") List<Double> decimalNumbers,
                         @Value("${basic.several.words}") List<String> words, @Value("${basic.several.choices}") List<Boolean> choices) {
